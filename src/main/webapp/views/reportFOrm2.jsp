...
<section id="collapsible">
  <div class="row">
    ...
    <div class="col-lg-6 col-sm-6 col-12">
     <div class="card">
        <div class="card-header">
          <h4 class="card-title">Baseline Information (FY <span id="financial-year"></span>)
</h4>
            </div>
...
<label class="form-label" for="basic-default-password1">Reduction in Specific Electricity Consumption in FY <span id="financial-year-next"></span> compared to the Baseline FY <span id="financial-year"></span>
</label>
          <div class="col-md-6 col-12 mb-1">
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Button on right" aria-describedby="button-addon2">
      ...
      <div class="card">
        ...
        <label class="form-label" for="basic-default-password1">HSD consumption
          ...
          <div class="col-md-6 col-12 mb-1">
            ...
            <label class="form-label" for="basic-default-password">Specific Thermal Energy Consumption, in GJ/ton (FY <span id="financial-year"></span>)
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
         <label class="form-label" for="basic-default-password1">Reduction in Specific Thermal Energy Consumption in FY <span id="financial-year-next"></span> compared to the Baseline FY <span id="financial-year"></span>
</label>
          <div class="col-md-6 col-12 mb-1">
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Button on right" aria-describedby="button-addon2">
