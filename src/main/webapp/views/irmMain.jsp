...
<span id="financial-year-next">2024-25</span> <span id="financial-year"></span>
           </label>
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card">
        ...
        <div class="card-content collapse show my-2">
         ...
         <span id="financial-year-next"></span>  Quantity of RDF to Cement Industries (FY 2025)<span id="financial-year"></span>
           </label>
          <div class="col-md-6 col-12 mb-1">
           <div class="invoice-total-item" style="
    text-align: center;
  ...
  <div class="row" style="zoom: 1;">
    <div class="col-md-6 col-sm-12">
      <div class="card">
        ...
        <div class="card-content collapse show my-2">
       <div class="card-body">
         <label class="form-label" for="basic-default-password1">Plantation of new trees<span id="financial-year-next"></span> (either w/in or outside the facility)<span id="financial-year"></span>
           </label>
          <div class="col-md-6 col-12 mb-1">
           <div class="invoice-total-item" style="
    text-align: center;
